...
<head>
    ...
    <link rel="shortcut icon" type="image/icon" href="../gambar/SIKERANG1.png">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <div class="logo" style="background-color: #624212">

            <span class="logo-lg"><b>SIKERANG</b></span>
        </div>
        <nav class="navbar navbar-static-top" role="navigation" style="background-color: #795114">
...
//                        } ?><!-- <br> --><?php //echo "Barang"; ?><!--<br>  <span style="font-weight: bold">--><?//= $_SESSION['username']; ?><!--</span></h4></li>-->
                    ...
                    <ul class="treeview-menu ">
                        <?php
                            ...
                            foreach ($query_get_kategori as $index=>$value){
                                ...
                                if ($_GET['pas'] == $trimmed_nama_kategori) { ?>
                                        background-color: #87b2a4;
                                <?php
                                    }
                                } else if (isset($_GET['p'])){
                                    if($_GET['p']=='material-m1'){
                                        ?>
                                            background-color: #87b2a4;
                                        <?php
                                    }
                                    ...
                                    <a style=""
                                       href="index.php?p=material-m<?php echo $value['id_jenis'];?>&id_jenis=<?php echo $value['id_jenis'];?>&pas=<?php echo $trimmed_nama_kategori;?>">
          ...
          <span class="label label-primary pull-right"></span>
                ...
                <li class="treeview <?php
                    if(isset($_GET['pas'])){
                if ($_GET['pas'] == 'formpengajuan' || $_GET['pas'] == 'datapengajuan') { ?>
                active
                <?php } } else if (isset($_GET['p'])){
                        if($_GET['p']=='detilpengajuan_table'){
                            ?> active <?php
                        }
                    } ?>
          ...
          <span class="label label-primary pull-right"></span>
                ...
                <li class="treeview <?php
                if(isset($_GET['pas'])){
                if ($_GET['pas'] == 'detil_lap_permintaan' || $_GET['pas'] == 'rekapitulasipermintaan') { ?> active
                <?php } }?>
