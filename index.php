...
<body class="hold-transition login-page" style="background-image: url('gambar/BACKGROUND2-SIKERANG.png');
background-size: cover; background-repeat: no-repeat; background-position: 0vh ; height: 500px">
	<div class="login-box" >
		<div class="login-logo">
		</div><!-- /.login-logo -->
		<div class="login-box-body" style="border-radius: 20px; background: #7b6d47">
<!--			<h3 class="text-center">SiKerang</h3>-->
<!--			<img src="gambar/SiKerang-Icon.png" style="width: 300px; height: 150px;">-->
			<img src="gambar/SIKERANG1.png" style="width: 100px; height: 100px; border-radius: 20%">
			<img src="gambar/SIKERANG-TITLE.png" style="width: 300px; height: 80px;">
			<form method="post">
				...
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-shield" style="color: #0e0e4e; opacity: 80%"></i></span>
						<select class="form-control col-md-5" name="level" required>
